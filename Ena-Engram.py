# For Ena channel 7 should be O1 and channel 8 should be O2 
...
def main():
    ...
    if board_id == 0:
        ...
        params.serial_port = "COM4" #change to your appropriate BCI serial port
    ...
    # past here prepares the arduino conencted to the ebikes motor
    ser = serial.Serial("COM5") #change to your appropriate arduino serial port
    ser.baudrate = 9600
...
### MAIN LOOP #############################
        ...
        while True:
            ...
            peripheral_awarness = get_peripheral_awarness(data)

            ser.write(peripheral_awarness)

            print(peripheral_awarness)
